...
var InnerSlider = /*#__PURE__*/ (function(_React$Component) {
  ...
  function InnerSlider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "trackRefHandler", function(
      ref
    ) {
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function() {
      ...
      if (
        ...
        dots = /*#__PURE__*/ _react["default"].createElement(
          _dots.Dots,
          dotProps
        );
      }
    ...
    _this.state = _objectSpread(
      _objectSpread({}, _initialState["default"]),
      {},
      {
  ...
  _createClass(InnerSlider, [
    {
      ...
      value: function didPropsChange(prevProps) {
        ...
        return (
          setTrackStyle ||
          _react["default"].Children.count(this.props.children) !==
            _react["default"].Children.count(prevProps.children)
        );
      }
    }
  ]);
